...
Loading our phyloseq object = cleaned TEP fish skin microbiome ASVs, with metadata, tax table, and otu table (no tree yet - see "ROHR_07_Gut_phylotree" for code to add phylogenetic tree to phyloseq object)
